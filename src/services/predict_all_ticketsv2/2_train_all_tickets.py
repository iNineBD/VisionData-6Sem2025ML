...
def train_lightgbm(X_train, X_test, y_train, y_test):
    with mlflow.start_run(run_name="LightGBM"):
        ...
        mlflow.sklearn.log_model(model, name="model_lightgbm", signature=signature, input_example=input_example)
...
def save_for_api(scaler, data, output_dir="../../../models/all_tickets_kaggle/"):
    ...
    print(f"✓ Dados salvos em data/processed/tickets_with_features.csv")
